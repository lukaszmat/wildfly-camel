...
import static org.wildfly.extension.camel.config.WildFlyCamelConfigPlugin.NS_DOMAIN_90;
...
public class StandaloneConfigTest extends ConfigTestSupport {
    ...
    public void testUnsupportedNamespaceVersion() throws Exception {
        ...
        doc.getRootElement().getChild("extensions", NS_DOMAIN_90).setNamespace(Namespace.getNamespace("urn:jboss:domain:99.99"));
